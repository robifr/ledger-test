...
import com.robifr.ledger.databinding.CustomerCardWideExpandedBinding;
import com.robifr.ledger.util.CurrencyFormat;
import java.math.BigDecimal;
import java.util.Objects;

public class CustomerCardExpandedComponent {
  @NonNull private final Context _context;
  @NonNull private final CustomerCardWideExpandedBinding _binding;

  public CustomerCardExpandedComponent(
      @NonNull Context context, @NonNull CustomerCardWideExpandedBinding binding) {
  ...
  public void reset() {
    ...
    this._binding.balance.setText(null);
    this._binding.debt.setText(null);
  }
