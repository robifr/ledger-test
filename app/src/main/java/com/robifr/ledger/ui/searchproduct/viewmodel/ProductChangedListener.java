...
class ProductChangedListener implements ModelChangedListener<ProductModel> {
  private final SearchProductViewModel _viewModel;

  public ProductChangedListener(@NonNull SearchProductViewModel viewModel) {
  ...
  private void _updateProducts(
    ...
    this._viewModel._onProductsChanged(
        updater.apply(this._viewModel.products().getValue().orElse(List.of()), products));
  }
}
